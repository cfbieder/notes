  ...
  fastify.get('/', {
    ...
    if (hasTextQuery) {
      ...
      result = await fastify.db.query(
        `SELECT n.id, n.title, n.notebook_id, n.is_inbox, n.note_type, n.auto_update, n.created_at, n.updated_at,
                MAX(GREATEST(
      ...
      result = await fastify.db.query(
        `SELECT DISTINCT n.id, n.title, n.notebook_id, n.is_inbox, n.note_type, n.auto_update,
